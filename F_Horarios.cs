    ...
    public partial class F_Horarios : Form
    {
        ...
        private void dgv_horarios_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if(contLinhas > 0)
            {
                ...
                tb_dscHorario.Text = dt.Rows[0].Field<string>("T_DSCHORARIO");
            }
        }

        private void btn_novoH_Click(object sender, EventArgs e)
        {
            tb_idHorario.Clear();
            tb_dscHorario.Clear();
            tb_dscHorario.Focus();
        ...
        private void btn_salvarH_Click(object sender, EventArgs e)
        {
            ...
            {
                vquery = "INSERT INTO tb_horarios (T_DSCHORARIO) VALUES ('" + tb_dscHorario.Text + "')";
            }
            else
            { 
                vquery = "UPDATE tb_horarios SET T_DSCHORARIO='" + tb_dscHorario.Text + "' WHERE N_IDHORARIO="+tb_idHorario.Text;
            }
            Banco.dml(vquery);
            vquery = @"
            SELECT
